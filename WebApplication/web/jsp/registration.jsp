...
<html>
    <head>
        ...
        <title>Registrazione | Snippet share</title>
    </head>
            ...
            <div id="content">
                ...
                <form name="registrationForm" method="POST" class="formClass" action="<%= Util.BASE %>RegistrationServlet" onsubmit="return validateForm();">
                    ...
                    <p>
                        ...
                        <input type="text" name="user" id="user" onfocus="clearForm()">
                    <%
                    ...
                    <% } %></p>
                    <p>
                        <label for="pass">Password: </label><input type="password" name="pass" id="pass" onfocus="clearForm()">
                    </p>
                    <p>
                        <input type="submit" value="Conferma" class="submit">
                    </p>
                </form>
